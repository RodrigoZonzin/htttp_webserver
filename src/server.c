...
//funcao para obter o content-type na construcao da resposta HTTP
...
//constroi a resposta HTTP para alguma requisicao
...
//função para tratar atender o cliente
